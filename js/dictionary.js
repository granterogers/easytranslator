...
const EN_BG = {
  ...
  'i am sick': 'болен съм',
  'where is the bathroom': 'къде е тоалетната',
  'where is the hospital': 'къде е болницата',
  'is there wifi': 'има ли wifi',
  'i am allergic to': 'алергичен съм към',
  'can you help me': 'можеш ли да ми помогнеш',
  'what time is it': 'колко е часът',
  'i am hungry': 'гладен съм',
  'i am thirsty': 'жаден съм',
  'i am tired': 'уморен съм',
  ...
  'one moment': 'един момент',
  'right now': 'точно сега',
  'not yet': 'все още не',
  ...
  ok: 'добре', okay: 'добре', help: 'помощ', welcome: 'добре дошли',
  ...
  and: 'и', or: 'или', but: 'но', with: 'с', without: 'без', in: 'в',
  on: 'на', at: 'при', from: 'от', to: 'до', for: 'за', of: 'на',
  before: 'преди', after: 'след', during: 'по време на', between: 'между',
  under: 'под', over: 'над', because: 'защото', if: 'ако', also: 'също',
  ...
  speak: 'говоря', understand: 'разбирам', think: 'мисля', feel: 'чувствам',
  believe: 'вярвам', remember: 'помня', forget: 'забравям', try: 'опитвам',
  change: 'променям', pay: 'плащам', cook: 'готвя',
  wash: 'мия', carry: 'нося', wear: 'нося', bring: 'нося', send: 'изпращам',
  meet: 'срещам', visit: 'посещавам', travel: 'пътувам',
  repair: 'ремонтирам', break: 'чупя', build: 'строя', grow: 'раста',
  live: 'живея', die: 'умирам', kill: 'убивам', fight: 'бия се',
  win: 'печеля', laugh: 'смея се', cry: 'плача', smile: 'усмихвам се',
  dance: 'танцувам', sing: 'пея', draw: 'рисувам', paint: 'рисувам',
  push: 'бутам', pull: 'дърпам', throw: 'хвърлям', catch: 'хващам',
  cut: 'режа', fill: 'пълня', turn: 'завивам',
  smoke: 'пуша', rest: 'почивам', enjoy: 'наслаждавам се', hope: 'надявам се',
  worry: 'притеснявам се', decide: 'решавам', check: 'проверявам',
  fix: 'поправям', share: 'споделям', hold: 'държа', follow: 'следвам',
  choose: 'избирам', continue: 'продължавам', explain: 'обяснявам',
  listen: 'слушам', watch: 'гледам', rent: 'наемам', order: 'поръчвам',
  ...
  street: 'улица', world: 'свят', address: 'адрес', map: 'карта',
  square: 'площад', bridge: 'мост', park: 'парк', church: 'църква',
  museum: 'музей', beach: 'плаж', mountain: 'планина', sea: 'море',
  lake: 'езеро', river: 'река', forest: 'гора', village: 'село',
  weather: 'време', sun: 'слънце', rain: 'дъжд', snow: 'сняг',
  wind: 'вятър', cloud: 'облак', storm: 'буря', sky: 'небе',
  head: 'глава', hand: 'ръка', arm: 'ръка', leg: 'крак', foot: 'крак',
  eye: 'око', ear: 'ухо', nose: 'нос', mouth: 'уста', hair: 'коса',
  heart: 'сърце', stomach: 'стомах', back: 'гръб', finger: 'пръст',
  tooth: 'зъб', skin: 'кожа', blood: 'кръв',
  shirt: 'риза', shoes: 'обувки', jacket: 'яке', hat: 'шапка',
  dress: 'рокля', pants: 'панталон', socks: 'чорапи', clothes: 'дрехи',
  doctor: 'лекар', nurse: 'медицинска сестра', teacher: 'учител',
  student: 'ученик', police: 'полиция', driver: 'шофьор', waiter: 'сервитьор',
  chef: 'готвач', engineer: 'инженер', lawyer: 'адвокат', pilot: 'пилот',
  farmer: 'фермер', soldier: 'войник', artist: 'художник', writer: 'писател',
  hospital: 'болница', pharmacy: 'аптека', bank: 'банка', school: 'училище',
  university: 'университет', office: 'офис', library: 'библиотека',
  bathroom: 'тоалетна', toilet: 'тоалетна', kitchen: 'кухня', garden: 'градина',
  wall: 'стена', floor: 'под', roof: 'покрив', wifi: 'wifi',
  battery: 'батерия', charger: 'зарядно', internet: 'интернет',
  music: 'музика', movie: 'филм', game: 'игра', sport: 'спорт',
  meat: 'месо', fish: 'риба', egg: 'яйце', cheese: 'сирене', fruit: 'плод',
  vegetable: 'зеленчук', apple: 'ябълка', banana: 'банан', sugar: 'захар',
  salt: 'сол', beer: 'бира', wine: 'вино', juice: 'сок', breakfast: 'закуска',
  lunch: 'обяд', dinner: 'вечеря', receipt: 'касова бележка', bill: 'сметка',
  wallet: 'портфейл', luggage: 'багаж', suitcase: 'куфар',
  ...
  down: 'надолу', here: 'тук', there: 'там', tall: 'висок', short: 'нисък',
  long: 'дълъг', wide: 'широк', narrow: 'тесен', heavy: 'тежък', light: 'лек',
  strong: 'силен', weak: 'слаб', clean: 'чист', dirty: 'мръсен', empty: 'празен',
  full: 'пълен', quiet: 'тих', loud: 'шумен', dangerous: 'опасен', safe: 'безопасен',
  free: 'свободен', busy: 'зает', ready: 'готов', sure: 'сигурен', wrong: 'грешен',
  correct: 'правилен', important: 'важен', interesting: 'интересен', boring: 'скучен',
  funny: 'забавен', sick: 'болен', healthy: 'здрав', tired: 'уморен',
  hungry: 'гладен', thirsty: 'жаден', afraid: 'уплашен', angry: 'ядосан',
  young: 'млад', rich: 'богат', poor: 'беден', same: 'същ', different: 'различен',
  first: 'първи', last: 'последен', next: 'следващ', early: 'рано', late: 'късно',
  every: 'всеки', all: 'всички', some: 'някои', many: 'много', few: 'малко',
  more: 'повече', less: 'по-малко', only: 'само', very: 'много', too: 'също',
